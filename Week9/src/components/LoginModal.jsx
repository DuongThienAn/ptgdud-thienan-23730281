...
const LoginModal = ({ isOpen, onClose, onSwitch, onLoginSuccess }) => {
          ...
          <div className="mt-4">
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                className="btn-primary w-full py-4 rounded-xl text-lg font-bold shadow-lg shadow-primary/20"
              >
                Continue
              </button>
            </div>
            ...
            <div className="space-y-3">
               <button 
                 onClick={() => onLoginSuccess({ name: 'Google User', avatar: '/img/avatar.png' })}
                 className="w-full py-3 flex items-center justify-center gap-3 bg-[#E8F0FF]/50 hover:bg-[#E8F0FF] rounded-xl text-[#4285F4] font-bold text-sm transition-colors border border-transparent"
               >
                  <img src="https://www.svgrepo.com/show/475656/google-color.svg" className="w-5 h-5" />
                  Continue with Google
               </button>
               <button 
                 onClick={() => onLoginSuccess({ name: 'Facebook User', avatar: '/img/avatar.png' })}
                 className="w-full py-3 flex items-center justify-center gap-3 bg-[#E8F0FF]/50 hover:bg-[#E8F0FF] rounded-xl text-[#1877F2] font-bold text-sm transition-colors border border-transparent"
               >
                  <img src="https://www.svgrepo.com/show/475647/facebook-color.svg" className="w-5 h-5" />
                  Continue with Facebook
               </button>
               <button 
                 onClick={() => onLoginSuccess({ name: 'Apple User', avatar: '/img/avatar.png' })}
                 className="w-full py-3 flex items-center justify-center gap-3 bg-gray-50 hover:bg-gray-100 rounded-xl text-black font-bold text-sm transition-colors border border-transparent"
               >
